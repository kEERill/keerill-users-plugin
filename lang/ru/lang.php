<?php return [
    ...
    'settings' => [
        ...
        'accessLogs_desc' => 'Просмотр всех попыток авторизоваться пользователя',
        'usersLogs' => 'Журнал активности пользователей',
        'usersLogs_desc' => 'Просмотр журнала с активными действиями пользователей',
        ...
        'allow_groups_desc' => 'Группы, не имеющие возможность авторизоваться на сайте',
        ...
        'allow_registration_desc' => 'Если эта опция выключена, то только администраторы смогут регистрировать пользователей',
        ...
        'group_guest_desc' => 'Если пользователь не авторизовался на сайте, то по умолчанию права будут наследоваться из этой группы',
        'group_no_activated' => 'Группа неактивированного пользователя',
        ...
        'activate_admin_desc' => 'Только администратор может активировать пользователя',
        'tabs' => [
            'system' => 'Система',
            'user' => 'Пользователь',
    ...
    'messages' => [
        ...
        'invalid_days' => 'Неправильное значение параметра "days"'
    ],
    'page' => [
        ...
        'use_user_auth' => [
            'label' => 'Перенаправление авторизованного пользователя',
            'comment' => 'Если эта опция включена, то авторизованные пользователи будут перенаправляться на специальную страницу'
        ],
        'page_redirect' => [
            'label' => 'Страница перенаправления',
            'comment' => 'Если опция "Перенаправление авторизованного пользователя" выключена, то на эту страницу будут перенаправляться все пользователи'
        ],
        'page_user_redirect' => [
            'label' => 'Страница перенаправления авторизованного пользователя',
            'comment' => 'Если опция "Перенаправление авторизованного пользователя" включена, то на эту страницу будут перенаправляться только авторизированные пользователи'
        ],
        'use_referer_param' => [
    ...
    'register' => [
        ...
        'is_user' => 'Вы уже авторизованы и не можете пройти регистрацию',
    ...
    'report' => [
        'num_days' => 'Количество дней для отображения данных'
    ]
];